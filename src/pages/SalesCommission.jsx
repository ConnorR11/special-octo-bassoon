...
export default function SalesCommission({deals=[],loading=false,setSelected,permissionLevel=0}) {
  ...
  const commsItems=filtered.filter(({type})=>type==="COMMS").length
  const adminItems=filtered.filter(({type})=>type==="ADMIN").length
  ...
  return <section>
    ...
    <div style={{display:"flex",alignItems:"stretch",gap:10,marginBottom:16}}>
      ...
      <div style={{display:"flex",gap:8,flex:"0 0 auto"}}>
        <div style={{minWidth:95,padding:"6px 14px",border:"1px solid #cfe2ef",borderRadius:9,background:"#f7fbff",display:"flex",flexDirection:"column",justifyContent:"center"}}><div style={{fontSize:9,fontWeight:800,color:"#6d8495",textTransform:"uppercase"}}>Comms · Deals</div><div style={{fontSize:20,fontWeight:800,color:"#263645"}}>{commsItems}</div></div>
        ...
        <div style={{minWidth:95,padding:"6px 14px",border:"1px solid #f1dccb",borderRadius:9,background:"#fffaf6",display:"flex",flexDirection:"column",justifyContent:"center"}}><div style={{fontSize:9,fontWeight:800,color:"#9a765c",textTransform:"uppercase"}}>Admins</div><div style={{fontSize:20,fontWeight:800,color:"#263645"}}>{adminItems}</div></div>
