    ...
    <div style={{display:"flex",alignItems:"stretch",gap:10,marginBottom:16}}>
      ...
      <div style={{position:"relative",flex:"0 0 auto"}}>
        ...
        {filtersOpen&&<div style={{position:"absolute",zIndex:20,top:52,right:0,width:280,padding:14,border:"1px solid #d7dee8",borderRadius:10,background:"#fff",boxShadow:"0 10px 30px rgba(0,0,0,.12)"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:12}}><strong style={{fontSize:12,color:"#263645"}}>Filters</strong>{activeFilterCount>0&&<button type="button" onClick={clearFilters} style={{border:0,background:"transparent",padding:0,color:"#1676b8",fontSize:10,fontWeight:700,cursor:"pointer"}}>Clear all</button>}</div>
