  ...
  return <section>
    ...
    <div style={{display:"flex",alignItems:"stretch",gap:10,marginBottom:16}}>
      ...
      <div style={{display:"flex",gap:8,flex:"0 0 auto"}}>
        <div style={{minWidth:150,padding:"6px 14px",border:"1px solid #cfe2ef",borderRadius:9,background:"#f7fbff",display:"flex",flexDirection:"column",justifyContent:"center"}}><div style={{fontSize:9,fontWeight:800,color:"#6d8495",textTransform:"uppercase"}}>Comms · Deals</div><div style={{display:"flex",alignItems:"center",gap:16,marginTop:3}}><div><div style={{fontSize:9,color:"#7b8790"}}>Booked</div><div style={{fontSize:20,fontWeight:800,color:"#1676b8",lineHeight:1.05}}>{commsBooked}</div></div><div style={{width:1,height:28,background:"#d9e2e8"}}/><div><div style={{fontSize:9,color:"#7b8790"}}>Not Booked</div><div style={{fontSize:20,fontWeight:800,color:"#a0a8ae",lineHeight:1.05}}>{commsNotBooked}</div></div></div></div>
        <div style={{minWidth:135,padding:"6px 14px",border:"1px solid #cfe2ef",borderRadius:9,background:"#f7fbff",display:"flex",flexDirection:"column",justifyContent:"center"}}><div style={{fontSize:9,fontWeight:800,color:"#6d8495",textTransform:"uppercase"}}>Net Value</div><div style={{fontSize:20,fontWeight:800,color:"#263645"}}>{money(totalNetSalesValue)}</div></div>
        <div style={{minWidth:155,padding:"6px 14px",border:"1px solid #cfe2ef",borderRadius:9,background:"#f7fbff",display:"flex",flexDirection:"column",justifyContent:"center"}}><div style={{fontSize:9,fontWeight:800,color:"#6d8495",textTransform:"uppercase"}}>Commission</div><div style={{fontSize:20,fontWeight:800,color:"#1676b8"}}>{money(totalCommission)}</div></div>
        <div style={{width:1,background:"#d9e2e8",margin:"4px 2px"}}/>
        <div style={{minWidth:150,padding:"6px 14px",border:"1px solid #f1dccb",borderRadius:9,background:"#fffaf6",display:"flex",flexDirection:"column",justifyContent:"center"}}><div style={{fontSize:9,fontWeight:800,color:"#9a765c",textTransform:"uppercase"}}>Admins</div><div style={{display:"flex",alignItems:"center",gap:16,marginTop:3}}><div><div style={{fontSize:9,color:"#7b8790"}}>Paid In</div><div style={{fontSize:20,fontWeight:800,color:"#1676b8",lineHeight:1.05}}>{adminPaidIn}</div></div><div style={{width:1,height:28,background:"#eadfd7"}}/><div><div style={{fontSize:9,color:"#7b8790"}}>Outstanding</div><div style={{fontSize:20,fontWeight:800,color:"#c45b18",lineHeight:1.05}}>{adminOutstanding}</div></div></div></div>
        <div style={{minWidth:120,padding:"6px 14px",border:"1px solid #f1dccb",borderRadius:9,background:"#fffaf6",display:"flex",flexDirection:"column",justifyContent:"center"}}><div style={{fontSize:9,fontWeight:800,color:"#9a765c",textTransform:"uppercase"}}>Admin Due</div><div style={{fontSize:20,fontWeight:800,color:"#c45b18"}}>{money(totalAdmin)}</div></div>
      </div>
