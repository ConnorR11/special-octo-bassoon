...
// 3. Pay on the Monday three weeks after that week (21 days later).
// Example: 14/09/2026 - 20/09/2026 -> 05/10/2026.
function getCommissionDate(deal, source = "commission") {
  ...
  // Convert the source date to the Monday starting its Monday-Sunday week.
  const day = date.getUTCDay()
  const daysBackToMonday = day === 0 ? 6 : day - 1
  date.setUTCDate(date.getUTCDate() - daysBackToMonday)

  // Payment is made three Mondays after the source week.
