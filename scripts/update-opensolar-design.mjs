...
if (next.includes(arrayTableMarker) && !next.includes("openSolarImageUrl || \"/opensolar-system-placeholder.svg\"")) {
  const toolbar = `  <div\n    className="opensolar-header"\n    style={{\n      display: "flex",\n      alignItems: "center",\n      justifyContent: "space-between",\n      gap: 12,\n      marginBottom: 12,\n    }}\n  >\n    <div style={{ minWidth: 0 }}>\n      <h2 style={{ margin: 0, fontSize: 15, fontWeight: 700, lineHeight: 1.3, color: "#172554" }}>OpenSolar System Design</h2>\n      <p style={{ margin: "3px 0 0", fontSize: 11, lineHeight: 1.4, color: "#64748b" }}>Enter the EPVS information for each roof / array.</p>\n    </div>\n    <OpenSolarDesignButton projectId={appointment?.open_solar_id} onDesignLoaded={handleOpenSolarDesignLoaded} />\n  </div>\n\n  <div style={{ marginBottom: 16, border: "1px solid #e2e8f0", borderRadius: 12, overflow: "hidden", background: "#f8fafc" }}>\n    <img\n      src={openSolarImageUrl || "/opensolar-system-placeholder.svg"}\n      alt={openSolarImageUrl ? "OpenSolar system design" : "OpenSolar system design placeholder"}\n      style={{ display: "block", width: "100%", maxHeight: 520, objectFit: "contain", background: "#f8fafc" }}\n    />\n  </div>\n\n`
...
console.log("OpenSolar UI patch applied with single header and inline read-only hardware display.")
